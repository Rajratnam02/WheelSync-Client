    ...
    (set) => ({
        ...
        registerUser: async (data) => {
            ...
            try {
                ...
                if (response.data.success) {
                    ...
                    return { error: null, success: true,message: response.data.message, user: response.data.user };
                }
            } catch (error) {
                const errMsg = error.response?.data?.message || "Something went wrong";
                set({ loading: false, error: errMsg, success: false, message: null, user: null });
                return { success: false,error: errMsg, message: null, user: null };
            }
        },
        ...
        loginUser: async (data) => {
            ...
            try {
                ...
                const errMsg = error.response?.data?.message || "Something went wrong";
                set({ loading: false, error: errMsg, success: false, message: null, user: null });
                return { error: errMsg, message: null, user: null , success: false};
            }
        },
