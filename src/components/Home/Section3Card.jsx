    ...
    <div className='h-[380px] shadow-[7px_7px_5px_5px_rgba(0,0,0,0.5)] rounded hover:-translate-y-5 transition-all duration-700 flex flex-col   w-[350px]'>
        ...
        <div className='flex flex-col bg-[#0F172A] w-full px-10 gap-5 py-5'>
            ...
            <div className='flex justify-between '>
                ...
                <p onClick={()=>{navigate(`/rent/${props.items._id}`)}} className='inter-600 hover:shadow-[0_0px_5px_5px_rgba(0,128,128,0.5)] flex items-center transition-all duration-300 justify-center px-3 rounded text-lg py-2 cursor-pointer bg-[#14B8A6]'>Rent Now</p>
            </div>
        </div>
    </div>
  )
